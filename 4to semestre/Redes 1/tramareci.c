...
void imprimirTrama(unsigned char *paq, int len)
{
    ...
    for(i=0;i<len;i++)
    {
        if(i%16==0)
            printf("\n");
        if(i<6){
            printf("\033[0;34m%.2x:\033[0m",paq[i]);
        }else if(i>13 && i<16){
            printf("\033[0;31m%.2x:\033[0m",paq[i]);
        }else if(i>15 && i<18){
            printf("\033[0;33m%.2x:\033[0m",paq[i]);
        }else if(i==18 || (i>31 && i<38)){
            printf("\033[0;90m%.2x:\033[0m",paq[i]);
        }else if(i==19){
            printf("\033[1;32m%.2x:\033[0m",paq[i]);       
        }else if(i>19 && i<22){
            printf("\033[0;36m%.2x:\033[0m",paq[i]);
        }else if(i>21 && i<28){
            printf("\033[0;35m%.2x:\033[0m",paq[i]);
        }else if(i>27 && i<32){
            printf("\033[1;33m%.2x:\033[0m",paq[i]);
        }else if(i>37 && i<42){
            printf("\033[0;32m%.2x:\033[0m",paq[i]);
        }else{
            printf("%.2x:",paq[i]);
        }
